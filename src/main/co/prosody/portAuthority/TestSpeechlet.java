 ...
 */
public class TestSpeechlet implements SpeechletV2 {
    ...
    public SpeechletResponse onIntent(SpeechletRequestEnvelope<IntentRequest> speechletRequestEnvelope) {
        ...
        switch(intentName) {
            ...
            case DataHelper.ALL_ROUTES_INTENT_NAME:
            	log.info("User null? {}", session.getUser());
            	log.info("Permissions null? {}", session.getUser().getPermissions());
            	log.info("Consent Token null? {}", session.getUser().getPermissions().getConsentToken());
